    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Content/css").Include(
                                      ...
                                      , "~/Content/generales.css"
                                      , "~/Content/footer.css"
                                      , "~/Content/busqueda.css"
                                      , "~/Content/detalleProducto.css"
                                      , "~/Content/alertaMensaje.css"
                                      , "~/Content/adventencia.css"));

            bundles.Add(new ScriptBundle("~/bundles/WebMeliJs").Include(
                           "~/Scripts/headers.js"
                          ,"~/Scripts/alertaAccion.js"));
